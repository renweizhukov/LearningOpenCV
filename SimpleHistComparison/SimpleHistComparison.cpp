...
void StrToHistComparisonMethod(
...
string HistComparisonMethodToStr(int histComparisonMethod)
{
...
int main(int argc, char** argv )
{
    ...
    StrToHistComparisonMethod(strDistMethod, histComparisonMethods, histCompPerfectMatchVals);
    ...
    StrToHsvChannels(strHsvChannels, hsvChannels, histSize, ranges);
    ...
    for (size_t compMethodIndex = 0; compMethodIndex < histComparisonMethods.size(); ++compMethodIndex)
    {
        ...
        cout << "[INFO]: The comparison result of the two histograms = " << compareResult << " with the method "
            << HistComparisonMethodToStr(histComparisonMethods[compMethodIndex]) << endl;
        cout << "[INFO]: The result for a perfect match of the method " << HistComparisonMethodToStr(histComparisonMethods[compMethodIndex])
